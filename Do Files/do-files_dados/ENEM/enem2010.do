...
NU_NOTA_REDACAO 997-1005
*/
using "E:\ENEM\microdados_enem2010_2\Microdados ENEM 2010\Dados Enem 2010\DADOS_ENEM_2010.txt";
save "E:\bases_dta\enem\enem2010_dados.dta", replace; 
# delimit cr
...
str Q56 69
str Q57 70*/
using "E:\ENEM\microdados_enem2010_2\Microdados ENEM 2010\Dados Enem 2010\QUESTIONARIO_SOCIO_ECONOMICO_ENEM_2010.txt";
save "E:\bases_dta\enem\enem2010_quest.dta", replace; 
# delimit cr
**************PRECISA MERGEAR COM enem2010_dados.dta
merge 1:1 NU_INSCRICAO using "E:\bases_dta\enem\enem2010_dados.dta"
...
save "E:\bases_dta\enem\enem2010.dta", replace;
