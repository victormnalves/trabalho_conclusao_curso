...
collpase em escola
com base no do-file 
enem2016_agregadoescola_replic_semconcludentes.do
*/
clear all
set more off
set trace on
import delimited "\\tsclient\E\\ENEM\microdados_enem2016\Microdados_enem_2016\DADOS\microdados_enem_2016.csv", delimiter(";")
# delimit ;
keep
nu_inscricao
nu_ano
...
# delimit cr
save "\\tsclient\E\\bases_dta\enem\enem2016_sujo_14.dta"", replace
use "\\tsclient\E\\bases_dta\enem\enem2016_sujo_14.dta"", clear
...
replace presentes_enem = 1 if tp_presenca_cn == 1 & tp_presenca_ch == 1	///
	& tp_presenca_lc == 1 & tp_presenca_mt == 1  & (tp_status_redacao == "1" | tp_status_redacao == "2" | tp_status_redacao == "3"| tp_status_redacao == "4" | tp_status_redacao == "5"| tp_status_redacao == "6" | tp_status_redacao == "7"| tp_status_redacao == "8" | tp_status_redacao == "9"	)
...
save "\\tsclient\E\\bases_dta\enem\enem2016_14.dta"", replace;
