...
set more off
set trace on
import delimited "E:\ENEM\microdados_enem2016\Microdados_enem_2016\DADOS\microdados_enem_2016.csv", delimiter(";")
# delimit ;
keep
nu_inscricao
nu_ano
...
# delimit cr
save "E:\bases_dta\enem\enem2016_sujo.dta", replace
use "E:\bases_dta\enem\enem2016_sujo.dta", clear
...
save "E:\bases_dta\enem\enem2016.dta", replace;
