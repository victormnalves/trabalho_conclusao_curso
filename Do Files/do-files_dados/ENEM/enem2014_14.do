...
collpase em escola
com base no do-file  import enem 2014.do e no 
enem2014_agregadoescola_replic_semconcludentes.do
*/
clear all
set more off
set trace on
import delimited "\\tsclient\E\\\ENEM\microdados_enem2014\microdados_enem2014\DADOS\MICRODADOS_ENEM_2014.csv", delimiter(",")
# delimit ;
keep
nu_inscricao
nu_ano
...
;
# delimit cr
save "\\tsclient\E\\bases_dta\enem\enem2014_sujo_14.dta", replace
use "\\tsclient\E\\bases_dta\enem\enem2014_sujo_14.dta", clear
...
save "\\tsclient\E\\\bases_dta\enem\enem2014_14.dta", replace;
