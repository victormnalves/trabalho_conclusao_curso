...
*não entendi para o que serve isso. talvez para dar zero para anos imediatamente antes da
*implementação? de qualquer maneira, se for isso, está errado
...
saveold "E:\bases_dta\ice_dados\ice_original.dta", replace
