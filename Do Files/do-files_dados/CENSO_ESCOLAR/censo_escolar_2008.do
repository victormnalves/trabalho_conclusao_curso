...
double ANO_CENSO 1-7 
double PK_COD_ENTIDADE 8-18
NO_ENTIDADE
str DESC_SITUACAO_FUNCIONAMENTO 29-43 
FK_COD_ESTADO 84-88 
str SIGLA 89-90
double FK_COD_MUNICIPIO 91-105 
...
double NUM_SALAS_EXISTENTES 165-171
double NUM_SALAS_UTILIZADAS 172-178 
...
using "D:\2008\DADOS\TS_ESCOLA.txt";
...
import delimited "D:\2008\DADOS\ESCOLAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
ANO_CENSO
PK_COD_ENTIDADE
...
*variável que indica a existencia de coleta de lixo periodica
...
*variável qu indica se existe a dependência diretoria
generate diretoria=.
...
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_escolas.dta", replace
...
# delimit ;
infix
FK_COD_ETAPA_ENSINO 121-124
double PK_COD_ENTIDADE 195-204
FK_COD_ESTADO 205-208


using "D:\2008\DADOS\TS_MATRICULA_PE.txt";
...
* então, necessário mudar os infix de txt para import delimited de csv
*o delimitador é o pipe
import delimited "D:\2008\DADOS\TURMAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_MOD_ENSINO
FK_COD_ETAPA_ENSINO
...
;
# delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_turmas.dta", replace
...
clear all
use "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_turmas.dta", clear
...
by(codigo_escola);
# delimit cr	
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_turmas_col(`x').dta", replace
...
ID_N_T_E_P 129-129
FK_COD_MOD_ENSINO 144-149
FK_COD_ETAPA_ENSINO 150-155
double PK_COD_ENTIDADE 198-209
FK_COD_ESTADO_ESCOLA 210-215
str SIGLA_ESCOLA 215-216
using "D:\2008\DADOS\TS_MATRICULA_PE.txt";
...
* então, necessário mudar os infix de txt para import delimited de csv
*o delimitador é o pipe
import delimited "D:\2008\DADOS\MATRICULA_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
NUM_IDADE
TP_SEXO
...
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas_`x'.dta", replace
}
use "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas_SUDESTE.dta"
append using "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas.dta", replace

foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
set more off
set trace on
use "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas.dta", clear
...
;
# delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas_col(`x').dta", replace
...
FK_COD_ESCOLARIDADE 98-102
FK_COD_ETAPA_ENSINO 557-561
double PK_COD_ENTIDADE 572-582

using "D:\2008\DADOS\TS_DOCENTES_PE.txt";

# delimit cr
*/


import delimited "D:\2008\DADOS\DOCENTES_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_ESCOLARIDADE
FK_COD_ETAPA_ENSINO
...
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes_`x'.dta", replace

}
use "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes_SUDESTE.dta"

append using "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes.dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
clear all
use "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes.dta", clear
...
by (codigo_escola);
#delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes_col(`x').dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
use "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_escolas.dta", clear
keep if sigla=="`x'"
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_turmas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_matriculas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_docentes_col(`x').dta"
save "D:\Dropbox\bases_dta\censo_escolar\2008\censo_escolar2008_`x'.dta", replace
