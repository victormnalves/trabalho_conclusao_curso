...
import delimited "D:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\ESCOLAS.CSV", delimiter("|")
...
save "D:\bases_dta\censo_escolar\censo_escolar2015_escolas.dta", replace
...
import delimited "D:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\TURMAS.CSV", delimiter("|")
...
save "D:\bases_dta\censo_escolar\censo_escolar2015_turmas.dta", replace

/*gerando para cada estado*/
/*PE, GO, CE, RJ, SP, ES*/
foreach x in "PE" "GO" "CE" "RJ" "SP" "ES" {
clear all
use "D:\bases_dta\censo_escolar\censo_escolar2015_turmas.dta", clear
...
;
# delimit cr
save "D:\bases_dta\censo_escolar\censo_escolar2015_turmas_col(`x').dta", replace
...
import delimited "D:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\MATRICULA_`x'.CSV", delimiter("|")
# delimit ;
keep
/*num_idade 
tp_sexo 
...
save "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas_`x'.dta", replace
}


use "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas_NORDESTE.dta", clear
append using "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas_SUDESTE.dta"
append using "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas_CO.dta"

save "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas.dta", replace

foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
set more off
use "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas.dta", clear
...
;
# delimit cr
save "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas_col(`x').dta", replace
...
import delimited "D:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\DOCENTES_`x'.CSV", delimiter("|")
# delimit ;
keep
/*
fk_cod_escolaridade 
...
rename co_entidade codigo_escola
rename co_uf codigo_uf
save "D:\bases_dta\censo_escolar\censo_escolar2015_docentes_`x'.dta"

}
use "D:\bases_dta\censo_escolar\censo_escolar2015_docentes_NORDESTE.dta", clear
append using "D:\bases_dta\censo_escolar\censo_escolar2015_docentes_SUDESTE.dta"

append using "D:\bases_dta\censo_escolar\censo_escolar2015_docentes_CO.dta"

save "D:\bases_dta\censo_escolar\censo_escolar2015_docentes.dta", replace


foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
clear all
use "D:\bases_dta\censo_escolar\censo_escolar2015_docentes.dta", clear
...
, by (codigo_escola)
save "D:\bases_dta\censo_escolar\censo_escolar2015_docentes_col(`x').dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
use "D:\bases_dta\censo_escolar\censo_escolar2015_escolas.dta", clear
merge 1:1 codigo_escola using "D:\bases_dta\censo_escolar\censo_escolar2015_turmas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\bases_dta\censo_escolar\censo_escolar2015_matriculas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\bases_dta\censo_escolar\censo_escolar2015_docentes_col(`x').dta"
save "D:\bases_dta\censo_escolar\censo_escolar2015_`x'.dta", replace
