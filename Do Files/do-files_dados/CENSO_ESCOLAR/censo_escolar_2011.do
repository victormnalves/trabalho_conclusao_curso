...
FK_COD_ESTADO 76-78
str SIGLA 79-80
double FK_COD_MUNICIPIO 81-88
double FK_COD_DISTRITO 89-96
...
double NUM_SALAS_EXISTENTES 154-158
double NUM_SALAS_UTILIZADAS 159-163 
...
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2011\Microdados Censo Escolar 2011\DADOS\TS_ESCOLA.txt";
using "D:\2011\DADOS\TS_ESCOLA.txt";
# delimit cr*/
...
import delimited "D:\2011\DADOS\ESCOLAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
ANO_CENSO
PK_COD_ENTIDADE
...
;
#delimit cr
*adição das variáveis ID_SALA_LEITURA ID_QUADRA_ESPORTES_DESCOBERTA ID_QUADRA_ESPORTES_COBERTA
...
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_escolas.dta", replace
...
# delimit ;
infix
FK_COD_ETAPA_ENSINO 115-118
double PK_COD_ENTIDADE 204-212
FK_COD_ESTADO 213-215
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2011\Microdados Censo Escolar 2011\DADOS\TS_TURMA\TS_TURMA.txt";
using "$dropboxA/CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2011\MicrodCenso Escolar2010/DADOS\TS_TURMA.txt";
...
* então, necessário mudar os infix de txt para import delimited de csv
* o delimitador é o pipe
import delimited "D:\2011\DADOS\TURMAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_MOD_ENSINO
FK_COD_ETAPA_ENSINO
...
;
# delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_turmas.dta", replace
...
clear all
use "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_turmas.dta", clear
...
by(codigo_escola);
# delimit cr	
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_turmas_col(`x').dta", replace
...
NUM_IDADE 44-48
str TP_SEXO 58-58
str TP_COR_RACA 59-59
str ID_ZONA_RESIDENCIAL 91-91 
ID_N_T_E_P 93-93
FK_COD_MOD_ENSINO 109-111
FK_COD_ETAPA_ENSINO 112-115
double PK_COD_ENTIDADE 141-149
FK_COD_ESTADO_ESCOLA 150-152
str SIGLA_ESCOLA 153-154
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2011\Microdados Censo Escolar 2011\DADOS\TS_MATRICULA_PE.txt";
using "D:\2011\DADOS\TS_MATRICULA_PE.txt";
...
* então, necessário mudar os infix de txt para import delimited de csv
* o delimitador é o pipe
import delimited "D:\2011\DADOS\MATRICULA_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
NUM_IDADE
TP_SEXO
...
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas_`x'.dta", replace
}
use "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas_SUDESTE.dta"
append using "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas.dta", replace

foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
set more off
set trace on
use "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas.dta", clear
...
;
# delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas_col(`x').dta", replace
...
FK_COD_ETAPA_ENSINO 535-538
double PK_COD_ENTIDADE 548-556
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2011\Microdados Censo Escolar 2011\DADOS\TS_DOCENTES_PE.txt";
using "D:\2011\DADOS\TS_DOCENTES_PE.txt";

# delimit cr
*/


import delimited "D:\2011\DADOS\DOCENTES_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_ESCOLARIDADE
FK_COD_ETAPA_ENSINO
...
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes_`x'.dta", replace

}
use "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes_SUDESTE.dta"

append using "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes.dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
clear all
use "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes.dta", clear
...
by (codigo_escola);
#delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes_col(`x').dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
use "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_escolas.dta", clear
keep if sigla=="`x'"
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_turmas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_matriculas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_docentes_col(`x').dta"
save "D:\Dropbox\bases_dta\censo_escolar\2011\censo_escolar2011_`x'.dta", replace
