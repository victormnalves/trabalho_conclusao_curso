...
FK_COD_ESTADO 181-183
str SIGLA 184-185
double FK_COD_MUNICIPIO 186-194
double FK_COD_DISTRITO 195-203
...
double NUM_SALAS_EXISTENTES 275-279
double NUM_SALAS_UTILIZADAS 280-284 
...
using "$dropboxA/CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2013\MicrodCenso Escolar2013/DADOS\TS_ESCOLA.txt";
# delimit cr */
...
import delimited "D:\2013\DADOS\ESCOLAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
ANO_CENSO
PK_COD_ENTIDADE
...
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_escolas.dta", replace
...
str SIGLA 225-226
using "$dropboxA/CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2013\MicrodCenso Escolar2013/DADOS\TS_TURMA.txt";
...
import delimited "D:\2013\DADOS\TURMAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_MOD_ENSINO
ID_MAIS_EDUCACAO
...
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_turmas.dta", replace
/*criando e renomeando as variáveis relevantes*/
/*gerando para cada estado*/
/*PE, GO, CE, RJ, SP, ES*/
foreach x in "PE" "GO" "CE" "RJ" "SP" "ES" {
clear all
use "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_turmas.dta", clear
...
by(codigo_escola);
# delimit cr	
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_turmas_col(`x').dta", replace
}
...
NUM_IDADE 49-52
str TP_SEXO 71-71
str TP_COR_RACA 72-72
str ID_ZONA_RESIDENCIAL 106-106 
ID_N_T_E_P 108-108
FK_COD_MOD_ENSINO 146-148
FK_COD_ETAPA_ENSINO 149-152
double PK_COD_ENTIDADE 178-186
FK_COD_ESTADO_ESCOLA 187-189
str SIGLA_ESCOLA 190-191
using "$dropboxA/CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2013\MicrodCenso Escolar2013/DADOS\TS_MATRICULA_`x'.txt";
# delimit cr*/
* por alguma razão, os dados do censo, antes de 2015, eram dados em txt. depois, em csv. ainda, o inep atualizou todas as bases até 2007 para csv
* então, necessário mudar os infix de txt para import delimited de csv
* o delimitador é o pipe
import delimited "D:\2013\DADOS\MATRICULA_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
NUM_IDADE
TP_SEXO
...
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas_`x'.dta", replace
}
use "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas_SUDESTE.dta"
append using "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas.dta", replace


foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
set more off
use "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas.dta", clear
...
;
# delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas_col(`x').dta", replace
}
...
using "$dropboxA/CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2013\MicrodCenso Escolar2013/DADOS\TS_DOCENTES_`x'.txt";

# delimit cr
*/


import delimited "D:\2013\DADOS\DOCENTES_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_ESCOLARIDADE
FK_COD_ETAPA_ENSINO
...
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes_`x'.dta", replace

}
use "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes_SUDESTE.dta"

append using "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes.dta", replace
...
set more off
set trace on
use "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes.dta", clear
...
by (codigo_escola);
#delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes_col(`x').dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
use "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_escolas.dta", clear
keep if sigla=="`x'"
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_turmas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_matriculas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_docentes_col(`x').dta"
save "D:\Dropbox\bases_dta\censo_escolar\2013\censo_escolar2013_`x'.dta", replace
