...
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2010\DADOS\TS_ESCOLA.txt";
using "D:\2010\DADOS\TS_ESCOLA.txt";
# delimit cr
*/
...
import delimited "D:\2010\DADOS\ESCOLAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
ANO_CENSO
PK_COD_ENTIDADE
...
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_escolas.dta", replace
...
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2010\DADOS\TS_TURMA.txt";
using "D:\2010\DADOS\TS_MATRICULA_PE.txt";
...
* então, necessário mudar os infix de txt para import delimited de csv
*o delimitador é o pipe
import delimited "D:\2010\DADOS\TURMAS.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_MOD_ENSINO
FK_COD_ETAPA_ENSINO
...
;
# delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_turmas.dta", replace
...
clear all
use "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_turmas.dta", clear
...
by(codigo_escola);
# delimit cr	
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_turmas_col(`x').dta", replace
...
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2010\DADOS\TS_MATRICULA_PE.txt";
using "D:\2010\DADOS\TS_MATRICULA_PE.txt";
# delimit cr
*/
* por alguma razão, os dados do censo, antes de 2015, eram dados em txt. depois, em csv. ainda, o inep atualizou todas as bases até 2007 para csv
* então, necessário mudar os infix de txt para import delimited de csv
* o delimitador é o pipe
import delimited "D:\2010\DADOS\MATRICULA_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
NUM_IDADE
TP_SEXO
...
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas_`x'.dta", replace
}
use "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas_SUDESTE.dta"
append using "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas.dta", replace

foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
set more off
set trace on
use "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas.dta", clear
...
;
# delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas_col(`x').dta", replace
...
FK_COD_ETAPA_ENSINO 502-505
double PK_COD_ENTIDADE 515-523
*using "E:\Bases de Dados\Educação\Censo Escolar\Censo Escolar 2010\DADOS\TS_DOCENTES_PE.txt";
using "D:\2010\DADOS\TS_DOCENTES_PE.txt";

# delimit cr
*/


import delimited "D:\2010\DADOS\DOCENTES_`x'.CSV", delimiter("|") case(upper)
# delimit ;
keep
FK_COD_ESCOLARIDADE
FK_COD_ETAPA_ENSINO
...
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes_`x'.dta", replace

}
use "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes_NORDESTE.dta", clear
append using "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes_SUDESTE.dta"

append using "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes_CO.dta"

save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes.dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
clear all
use "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes.dta", clear
...
by (codigo_escola);
#delimit cr
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes_col(`x').dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
use "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_escolas.dta", clear
keep if sigla=="`x'"
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_turmas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_matriculas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_docentes_col(`x').dta"
save "D:\Dropbox\bases_dta\censo_escolar\2010\censo_escolar2010_`x'.dta", replace
