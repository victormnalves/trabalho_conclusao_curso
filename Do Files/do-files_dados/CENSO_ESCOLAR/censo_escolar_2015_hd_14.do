...
import delimited "G:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\ESCOLAS.CSV", delimiter("|")
...
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_escolas.dta", replace
...
import delimited "G:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\TURMAS.CSV", delimiter("|")
...
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_turmas.dta", replace

/*gerando para cada estado*/
/*PE, GO, CE, RJ, SP, ES*/
foreach x in "PE" "GO" "CE" "RJ" "SP" "ES" {
clear all
use "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_turmas.dta", clear
...
;
# delimit cr
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_turmas_col(`x').dta", replace
...
import delimited "G:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\MATRICULA_`x'.CSV", delimiter("|")
# delimit ;
keep
/*num_idade 
tp_sexo 
...
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas_`x'.dta", replace
}


use "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas_NORDESTE.dta", clear
append using "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas_SUDESTE.dta"
append using "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas_CO.dta"

save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas.dta", replace

foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
set more off
use "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas.dta", clear
...
;
# delimit cr
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas_col(`x').dta", replace
...
import delimited "G:\CENSO ESCOLAR 2002 - 2017\micro_censo_escolar_2015\2015\DADOS\DOCENTES_`x'.CSV", delimiter("|")
# delimit ;
keep
/*
fk_cod_escolaridade 
...
rename co_entidade codigo_escola
rename co_uf codigo_uf
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes_`x'.dta"

}
use "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes_NORDESTE.dta", clear
append using "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes_SUDESTE.dta"

append using "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes_CO.dta"

save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes.dta", replace


foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
clear all
use "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes.dta", clear
...
collapse (sum) n_profs_em_inte_1 n_profs_em_inte_2 n_profs_em_inte_3 n_profs_em_inte_4 n_profs_em_inte_ns ///
n_profs_sup_em_inte_1 n_profs_sup_em_inte_2 n_profs_sup_em_inte_3 n_profs_sup_em_inte_4 n_profs_sup_em_inte_ns ///
(mean) p_profs_sup_em_inte_1 p_profs_sup_em_inte_2 p_profs_sup_em_inte_3 p_profs_sup_em_inte_4 p_profs_sup_em_inte_ns, by (codigo_escola)


collapse 
(sum) n_profs_fund_5_8anos-n_profs_sup_fund_9_9anos  
(mean) p_profs_sup_fund_5_8anos-p_profs_sup_fund_9_9anos 
(sum) n_profs_fund_5_8anos-n_profs_sup_em_3  
(mean) p_profs_sup_fund_5_8anos-p_profs_sup_em_3
(sum) n_profs_em_inte_1 n_profs_em_inte_2 n_profs_em_inte_3 
n_profs_em_inte_4 n_profs_em_inte_ns 
n_profs_sup_em_inte_1 n_profs_sup_em_inte_2
 n_profs_sup_em_inte_3 n_profs_sup_em_inte_4 n_profs_sup_em_inte_ns 
(mean) p_profs_sup_em_inte_1 p_profs_sup_em_inte_2 p_profs_sup_em_inte_3 
p_profs_sup_em_inte_4 p_profs_sup_em_inte_ns


, by (codigo_escola)
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes_col(`x').dta", replace
...
foreach x in "PE" "CE" "RJ" "SP" "ES" "GO" {
use "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_escolas.dta", clear
merge 1:1 codigo_escola using "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_turmas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_matriculas_col(`x').dta"
drop _merge
merge 1:1 codigo_escola using "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_docentes_col(`x').dta"
save "G:\bases_dta\censo_escolarcenso_escolarcenso_escolar2015_`x'.dta", replace
