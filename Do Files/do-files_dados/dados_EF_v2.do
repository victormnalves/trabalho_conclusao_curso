...
log using "$folderservidor\\logfiles/dados_EF_v2.log", replace
...
replace pb = 1 if ano_prova_brasil !=.	
	save "$folderservidor\dados_EF_14_v2.dta",replace
	save "\\tsclient\C\Users\Leonardo.idea-PC\OneDrive\EESP_ECONOMIA_mestrado_acadêmico\Dissertação\ICE\dados_ICE\Análise_Leonardo\Bases\dados_EF_14_v1.dta", replace
	log close
