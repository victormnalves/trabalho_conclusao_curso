...
global output "\\fs-eesp-01\EESP\Usuarios\leonardo.kawahara\resultados resultados"
...
log using "$Logfolder/ef_maha_v3.log", replace
...
global varlist_censo2007 pib_capita_reais_real_2015 pop   ///
				...
				n_mulheres_ef n_brancos_ef n_prof_total_ef p_ef_superior ///
...
merge 1:m codigo_escola ano using "$folderservidor\dados_EF_14_v3.dta"
...
save "$folderservidor\dados_EF_par_v3.dta", replace
