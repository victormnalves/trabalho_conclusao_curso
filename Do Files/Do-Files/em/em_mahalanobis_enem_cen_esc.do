...
log using "$folderservidor\logfiles/em_mahalanobis_cen_esc_enem.log", replace
...
save "$folderservidor\dados_EM_14_enem_only.dta",replace
...
merge 1:m codigo_escola ano using "$folderservidor\dados_EM_14_enem_only.dta"
...
save "$folderservidor\dados_EM_par_cen_esc_enem.dta", replace
