...
e as escolas ou do estado do rio (33) ou de sp (35)
*/
...
probabilidade de ser tratado dado número de alunos no ensino fundamental
e taxa de participação na pb
gerando para cada estado
aqui, condicional em numero de alunos e taxa de participação de alunos, 
a participação do ice é independente
*/
...
/*
gerando as notas padronizadas da redação, das escolas no CE e PE,
padronizadas no ano e nos dois estados
*/
