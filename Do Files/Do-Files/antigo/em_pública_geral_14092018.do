...
log using "$Logfolder/em_publica_14092018.log", replace
...
xtreg enem_nota_objetivab_std d_ice_nota d_ano* $controles , fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel replace label ctitle(enem objetiva, fe cluster estado)

xtreg enem_nota_objetivab_std d_ice_nota d_ice_nota_inte d_ano* $controles, fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel append label ctitle(enem objetiva, fe cluster estado, integral)

*com propensity score
xtreg enem_nota_objetivab_std d_ice_nota d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel append label ctitle(enem objetiva, fe cluster estado ps)

xtreg enem_nota_objetivab_std d_ice_nota d_ice_nota_inte d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel append label ctitle(enem objetiva, fe cluster estado ps, integral)
...
*sem propensity score
xtreg `x' d_ice_nota d_ano* $controles , fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel append label ctitle( `x', fe cluster estado)

xtreg `x' d_ice_nota d_ice_nota_inte d_ano* $controles, fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel append label ctitle( `x', fe cluster estado, integral)

*com propensity score
xtreg `x' d_ice_nota d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel append label ctitle( `x', fe cluster estado ps)

xtreg `x' d_ice_nota d_ice_nota_inte d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_notas_14092018.xls", excel append label ctitle( `x', fe cluster estado ps, integral)
...
*sem propensity score
xtreg apr_em_std d_ice_fluxo d_ano* $controles , fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel replace label ctitle(apr_em_std, fe cluster estado)

xtreg apr_em_std d_ice_fluxo d_ice_fluxo_inte d_ano* $controles, fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel append label ctitle(apr_em_std, fe cluster estado, integral)

*com propensity score
xtreg apr_em_std d_ice_fluxo d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel append label ctitle(apr_em_std, fe cluster estado ps)

xtreg apr_em_std d_ice_fluxo d_ice_fluxo_inte d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel append label ctitle(apr_em_std, fe cluster estado ps, integral)

*rep_em_std aba_em_std dist_em_std
foreach x in "rep_em_std" "aba_em_std" "dist_em_std" {
*sem propensity score
xtreg `x' d_ice_fluxo d_ano* $controles , fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel append label ctitle( `x', fe cluster estado)

xtreg `x' d_ice_fluxo d_ice_fluxo_inte d_ano* $controles, fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel append label ctitle( `x', fe cluster estado, integral)

*com propensity score
xtreg `x' d_ice_fluxo d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel append label ctitle( `x', fe cluster estado ps)

xtreg `x' d_ice_fluxo d_ice_fluxo_inte d_ano* $controles [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "$output/em_publica_geral_fluxo_14092018.xls", excel append label ctitle( `x', fe cluster estado ps, integral)
