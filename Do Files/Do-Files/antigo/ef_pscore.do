...
*gerando o pscore para o rio de janeiro
pscore ice n_alunos_ef taxa_participacao_pb_9  if ano==2009&codigo_uf==33&dep!=4, pscore(pscores_rj)

*gerando o pscore para são paulo
pscore ice n_alunos_ef taxa_participacao_pb_9   if ano==2011&codigo_uf==35&dep!=4, pscore(pscores_sp)

*gerando o pscore para o espírito santo
*pscore ice n_alunos_ef taxa_participacao_pb_9   if ano==2015&codigo_uf==32&dep!=4, pscore(pscores_es)
...
*replace pscore_total=1/(1-pscores_es) if codigo_uf==32&dep!=4&ice==0
