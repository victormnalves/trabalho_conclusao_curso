...
enem_nota_redacao_std enem_nota_objetivab_std
*/
gen ano_ice_sintetico = ano_ice
replace ano_ice_sintetico = 2008 if ano_ice_sintetico ==.
...
*/
replace tempo=0 if ano==ano_ice_sintetico-6
replace tempo=1 if ano==ano_ice_sintetico-5
replace tempo=2 if ano==ano_ice_sintetico-4
replace tempo=3 if ano==ano_ice_sintetico-3 
replace tempo=4 if ano==ano_ice_sintetico-2
replace tempo=5 if ano==ano_ice_sintetico-1
replace tempo=6 if ano==ano_ice_sintetico
replace tempo=7 if ano==ano_ice_sintetico+1 
replace tempo=8 if ano==ano_ice_sintetico+2
replace tempo=9 if ano==ano_ice_sintetico+3
replace tempo=10 if ano==ano_ice_sintetico+4
replace tempo=11 if ano==ano_ice_sintetico+5
replace tempo=12 if ano==ano_ice_sintetico+6
iis codigo_escol
tis tempo
