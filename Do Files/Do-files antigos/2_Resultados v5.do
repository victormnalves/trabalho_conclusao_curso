...
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', controle pub, tudo) 
...
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', controle pub, integral) 
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4 , fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', controle pub) 
...
outreg2 using "${output}ICE_resultados_ps_em_pe_s_inte_new.xls", excel append label ctitle(`x', controle pub, pe) 
lincom d_ice + d_ice_inte
...
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', apoio forte)
...
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', apoio medio)
...
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', apoio fraco)
...
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', sem apoio)
...
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', com algum apoio)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', engaj gov)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', engaj secret)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', time seduc)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', marcos lei)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', todos marcos)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', sel diretores)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', sel profes)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', projeto de vida)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_ps_em_new.xls", excel append label ctitle(`x', outros alavancas)
...
***Apenas semi-integral
*xtreg `x' d_ice1 d_ice2 d_ice3 d_ice4 d_ice5 d_ice6 d_ice7 d_ice8 d_ice9 d_ice10 d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3| tempo==4 | tempo==5 | tempo==6| tempo==7 | tempo==8 | tempo==9 | tempo==10)&(integral==0|ice==0) , fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_cum_em_new.xls", excel append label ctitle(`x', 9 anos) 
