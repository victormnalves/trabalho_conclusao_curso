...
xtreg `x' d_ice d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4 &(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', controle pub, inte) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', controle pub, semi-inte)
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', apoio forte)
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', apoio medio)
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', apoio fraco)
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', sem apoio)
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', com algum apoio)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', engaj gov)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', engaj secret)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', time seduc)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', marcos lei)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', todos marcos)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', sel diretores)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', sel profes)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', projeto de vida)
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em.xls", excel append label ctitle(`x', outros alavancas)
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_em_pe_s_inte.xls", excel append label ctitle(`x', controle pub, pe) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 2 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 3 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 4 anos) 
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3 | tempo==4 | tempo==5)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 5 anos) 
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3| tempo==4 | tempo==5 | tempo==6)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 6 anos) 
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3| tempo==4 | tempo==5 | tempo==6| tempo==7)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 7 anos) 

xtreg `x' d_ice1 d_ice2 d_ice3 d_ice4 d_ice5 d_ice6 d_ice7 d_ice8 d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3| tempo==4 | tempo==5 | tempo==6| tempo==7 | tempo==8)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 8 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 9 anos) 

xtreg `x' d_ice1 d_ice2 d_ice3 d_ice4 d_ice5 d_ice6 d_ice7 d_ice8 d_ice9 d_ice10 d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3| tempo==4 | tempo==5 | tempo==6| tempo==7 | tempo==8 | tempo==9| tempo==10)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_em.xls", excel append label ctitle(`x', 10 anos) 
...
*xtreg `x' d_ice d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
**/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if (integral==1|ice==0) , fe cluster(codigo_uf)
*outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_ef.xls", excel append label ctitle(`x', pub e priv) 

*xtreg `x' d_ice d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
**/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if (dep==4|ice==1) &(integral==1|ice==0), fe cluster(codigo_uf)
*outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_ef.xls", excel append label ctitle(`x', controle priv) 
...
*xtreg `x' d_ice d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
**/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca internet mais_educ [pw=pscore_total] if dep!=4&(integral==1|ice==0), fe cluster(codigo_uf)
*outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_ef.xls", excel append label ctitle(`x', pub mais educ) 
...
foreach x in  "apr_ef_std" "rep_ef_std" "aba_ef_std" "dist_ef_std" {


***Controlando por demais carateristicas da escola 
xtreg `x' d_ice1 d_ice2 d_ano* pb_esc_sup_mae pb_esc_sup_pai n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ef.xls", excel append label ctitle(`x', 2 anos) 

xtreg `x' d_ice1 d_ice2 d_ice3 d_ano* pb_esc_sup_mae pb_esc_sup_pai n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ef.xls", excel append label ctitle(`x', 3 anos) 

xtreg `x' d_ice1 d_ice2 d_ice3 d_ice4 d_ano* pb_esc_sup_mae pb_esc_sup_paia n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3 | tempo==4)&(integral==1|ice==0) , fe cluster(codigo_uf)
...
foreach x in  "media_lp_prova_brasil_9_std" "media_mt_prova_brasil_9_std"  {
...
xtreg `x' d_ice1 d_ice2 d_ice3 d_ice4 d_ano* pb_esc_sup_mae pb_esc_sup_pai n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4&(tempo==0|tempo==1|tempo==2| tempo==3 | tempo==4)&(integral==1|ice==0) , fe cluster(codigo_uf)
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ef.xls", excel append label ctitle(`x', 4 anos) 
...
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if dep!=4  & codigo_uf==`xx' &(integral==1|ice==0), fe 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ce.xls", excel append label ctitle(`x', 2 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ce.xls", excel append label ctitle(`x', 3 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ce.xls", excel append label ctitle(`x', 4 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ce.xls", excel append label ctitle(`x', 5 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ce.xls", excel append label ctitle(`x', 6 anos) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_cum_ce.xls", excel append label ctitle(`x', 7 anos) 
...
xtreg `x'33_std d_ice d_ano* pb_esc_sup_mae pb_esc_sup_pai nalunos nbrancos nmulheres/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if codigo_uf==33&dep==3, fe 
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_ef_33v2.xls", excel append label ctitle(`x', controle pub) 
}

foreach x in  "media_lp_prova_brasil_9" "media_mt_prova_brasil_9" "media_pb_9" "apr_ef"  "rep_ef"  "aba_ef" "dist_ef" {

xtreg `x'33_std d_ice d_ano* pb_esc_sup_mae pb_esc_sup_pai nalunos nbrancos nmulheres/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total] if codigo_municipio_novo==3304557&dep==3, fe 
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_ps_ef_33v2.xls", excel append label ctitle(`x', controle pub, só mun RJ) 
}



* Todos os estados (ambas as jornadas)
foreach x in  "apr_ef"  "rep_ef"  "aba_ef" "dist_ef" {
foreach xx in 23 26 {
