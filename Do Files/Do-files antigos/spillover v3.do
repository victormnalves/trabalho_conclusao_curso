...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_spilloverv3.xls", excel append label ctitle(`x', escola2) 
...
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_spillover_ufv3.xls", excel append label ctitle(`x', `xx') 
...
pscore ice n_alunos_ef prop_alunos_ice_ef taxa_participacao_pb if ano==2011&codigo_uf==35, pscore(pscores_sp)
