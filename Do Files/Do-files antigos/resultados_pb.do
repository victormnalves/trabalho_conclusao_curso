...
reg `x'`xx'_std ice d_uf* d_dep* d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria nalunos nbrancos nmulheres [pw=pscore_total] if codigo_uf==`xx'
...
*** Controlando por caracteristicas do aluno
reg `x'`xx'_std ice int_ice_2013 d_uf* d_dep* d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria nalunos nbrancos nmulheres [pw=pscore_total] if codigo_uf==`xx'
outreg2 using "E:\CMICRO\_CHV\ICE\Dados ICE\ICE_resultados_preliminares_pb.xls", excel append label ctitle(`x', aluno, cumul)  

***Controlando por carateristicas da escola que independem da escola
reg `x'`xx'_std ice int_ice_2013 d_uf* d_dep* d_ano* e_escol_sup_pai e_escol_sup_mae e_renda_familia_5_salarios e_casa_propria nalunos nbrancos nmulheres/*
*/ rural agua eletricidade esgoto lixo_coleta [pw=pscore_total]  if codigo_uf==`xx'
