...
save "Dados ICE\base original ice.dta", replace
...
*dropar escola com codigo_inep duplicado e errado (de qualquer maneira, o ano de entrada e 2015, entao a escola esta fora da an�lise)
drop if nome_escola=="LOURENCO FILHO" & codigo_escola==35003669

*mergear com a primeira base enviada pelo ICE
merge 1:1 codigo_escola using "Dados ICE\base original ice.dta"
