...
********************************************************************************************************
***************************** Modificar base original - NÃO ALTERAR ************************************
********************************************************************************************************
clear
cap cd "C:\Users\vladimir.ponczek\Documents\ICE\"
import excel "Dados ICE\Base de dados estudo 2016 v1.xlsx", sheet("Escolas") firstrow
*import excel "Dados ICE\Base de dados para stata.xlsx", sheet("Plan1") firstrow
...
save "Dados ICE\base original ice_fluxo.dta", replace


*******************************************************************************************************************
**************************** Juntas Base de Alavancas - NAO ALTERAR ***********************************************
*******************************************************************************************************************
clear
import excel "Dados ICE\Base_geral_escolas_alavancas.xlsx", sheet("Plan1") firstrow
...
*dropar escola com codigo_inep duplicado e errado (de qualquer maneira, o ano de entrada e 2015, entao a escola esta fora da an⭩se)
drop if nome_escola=="LOURENCO FILHO" & codigo_escola==35003669

*mergear com a primeira base enviada pelo ICE
merge 1:1 codigo_escola using "Dados ICE\base original ice_fluxo.dta"
...
*/
***********************************************
**** Mergear ENEM, SAEB, PB, Fluxo - ALTERAR *
***********************************************
...
***************************
clear
use "Dados ICE\base original ice_fluxo.dta"
keep if uf=="PE"
...
save "Dados ICE\ice_completo_pe_fluxo.dta", replace
...
save "Dados ICE\ice_completo_ce_fluxo.dta", replace
...
save "Dados ICE\ice_completo_rj_fluxo.dta", replace
...
save "Dados ICE\ice_completo_sp_fluxo.dta", replace
...
save "Dados ICE\ice_completo_go_fluxo.dta", replace
...
use "Dados ICE\ice_completo_go_fluxo.dta", clear

local x "pe rj ce sp"

foreach i in `x'{
append using "Dados ICE\ice_completo_`i'_fluxo"
}
...
save "Dados ICE\ice_clean_fluxo.dta", replace
