...
******************************** GERAL EM ******************************************************
************************************************************************************************
cd C:\Users\marcela.msilva\Desktop\
global output "resultados_2014_3/"
...
*"enem_nota_matematica_std" "enem_nota_ciencias_std" "enem_nota_humanas_std" "enem_nota_linguagens_std" "enem_nota_redacao_std" "apr_em_std"
...
*outreg2 using "\\fs-eesp-01\EESP\Usuarios\_CHV\ICE\Dados ICE\ICE_resultados_spillover_new.xls", excel append label ctitle(`x', escola2) 
...
foreach x in "enem_nota_matematica_std" "enem_nota_ciencias_std" "enem_nota_humanas_std" "enem_nota_linguagens_std" "enem_nota_red_std"  "enem_nota_ob_std"  {
...
foreach x in  "media_lp_prova_brasil_9_std" "media_mt_prova_brasil_9_std" "media_pb_9_std"  {


***Controlando por demais carateristicas da escola 
xtreg `x' m_tem_ice d_ano* pb_esc_sup_mae pb_esc_sup_pai n_alunos_ef_em_ep n_mulheres_ef_em_ep n_brancos_ef_em_ep/*
*/ rural agua eletricidade esgoto lixo_coleta sala_professores lab_info lab_ciencias quadra_esportes biblioteca   internet [pw=pscore_total], fe cluster(codigo_uf)
outreg2 using "${output}ICE_resultados_spillover_ef_new.xls", excel append label ctitle(`x', escola2) 
